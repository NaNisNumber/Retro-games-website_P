 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(t){function e(O,b){var U=O.length;O.push(b);e:for(;0<U;){var Z=U-1>>>1,le=O[Z];if(0<i(le,b))O[Z]=b,O[U]=le,U=Z;else break e}}function n(O){return O.length===0?null:O[0]}function r(O){if(O.length===0)return null;var b=O[0],U=O.pop();if(U!==b){O[0]=U;e:for(var Z=0,le=O.length,Bt=le>>>1;Z<Bt;){var lt=2*(Z+1)-1,an=O[lt],at=lt+1,zt=O[at];if(0>i(an,U))at<le&&0>i(zt,an)?(O[Z]=zt,O[at]=U,Z=at):(O[Z]=an,O[lt]=U,Z=lt);else if(at<le&&0>i(zt,U))O[Z]=zt,O[at]=U,Z=at;else break e}}return b}function i(O,b){var U=O.sortIndex-b.sortIndex;return U!==0?U:O.id-b.id}if(typeof performance=="object"&&typeof performance.now=="function"){var s=performance;t.unstable_now=function(){return s.now()}}else{var o=Date,l=o.now();t.unstable_now=function(){return o.now()-l}}var a=[],u=[],d=1,c=null,h=3,m=!1,v=!1,y=!1,S=typeof setTimeout=="function"?setTimeout:null,p=typeof clearTimeout=="function"?clearTimeout:null,f=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function _(O){for(var b=n(u);b!==null;){if(b.callback===null)r(u);else if(b.startTime<=O)r(u),b.sortIndex=b.expirationTime,e(a,b);else break;b=n(u)}}function E(O){if(y=!1,_(O),!v)if(n(a)!==null)v=!0,Ue(C);else{var b=n(u);b!==null&&ot(E,b.startTime-O)}}function C(O,b){v=!1,y&&(y=!1,p(x),x=-1),m=!0;var U=h;try{for(_(b),c=n(a);c!==null&&(!(c.expirationTime>b)||O&&!q());){var Z=c.callback;if(typeof Z=="function"){c.callback=null,h=c.priorityLevel;var le=Z(c.expirationTime<=b);b=t.unstable_now(),typeof le=="function"?c.callback=le:c===n(a)&&r(a),_(b)}else r(a);c=n(a)}if(c!==null)var Bt=!0;else{var lt=n(u);lt!==null&&ot(E,lt.startTime-b),Bt=!1}return Bt}finally{c=null,h=U,m=!1}}var N=!1,T=null,x=-1,L=5,R=-1;function q(){return!(t.unstable_now()-R<L)}function Ut(){if(T!==null){var O=t.unstable_now();R=O;var b=!0;try{b=T(!0,O)}finally{b?fe():(N=!1,T=null)}}else N=!1}var fe;if(typeof f=="function")fe=function(){f(Ut)};else if(typeof MessageChannel<"u"){var _e=new MessageChannel,me=_e.port2;_e.port1.onmessage=Ut,fe=function(){me.postMessage(null)}}else fe=function(){S(Ut,0)};function Ue(O){T=O,N||(N=!0,fe())}function ot(O,b){x=S(function(){O(t.unstable_now())},b)}t.unstable_IdlePriority=5,t.unstable_ImmediatePriority=1,t.unstable_LowPriority=4,t.unstable_NormalPriority=3,t.unstable_Profiling=null,t.unstable_UserBlockingPriority=2,t.unstable_cancelCallback=function(O){O.callback=null},t.unstable_continueExecution=function(){v||m||(v=!0,Ue(C))},t.unstable_forceFrameRate=function(O){0>O||125<O?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):L=0<O?Math.floor(1e3/O):5},t.unstable_getCurrentPriorityLevel=function(){return h},t.unstable_getFirstCallbackNode=function(){return n(a)},t.unstable_next=function(O){switch(h){case 1:case 2:case 3:var b=3;break;default:b=h}var U=h;h=b;try{return O()}finally{h=U}},t.unstable_pauseExecution=function(){},t.unstable_requestPaint=function(){},t.unstable_runWithPriority=function(O,b){switch(O){case 1:case 2:case 3:case 4:case 5:break;default:O=3}var U=h;h=O;try{return b()}finally{h=U}},t.unstable_scheduleCallback=function(O,b,U){var Z=t.unstable_now();switch(typeof U=="object"&&U!==null?(U=U.delay,U=typeof U=="number"&&0<U?Z+U:Z):U=Z,O){case 1:var le=-1;break;case 2:le=250;break;case 5:le=1073741823;break;case 4:le=1e4;break;default:le=5e3}return le=U+le,O={id:d++,callback:b,priorityLevel:O,startTime:U,expirationTime:le,sortIndex:-1},U>Z?(O.sortIndex=U,e(u,O),n(a)===null&&O===n(u)&&(y?(p(x),x=-1):y=!0,ot(E,U-Z))):(O.sortIndex=le,e(a,O),v||m||(v=!0,Ue(C))),O},t.unstable_shouldYield=q,t.unstable_wrapCallback=function(O){var b=h;return function(){var U=h;h=b;try{return O.apply(this,arguments)}finally{h=U}}}})(Kp);(function(t){t.exports=Kp})(Xy);/**
 * @license React
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function WC(t,e){const n=Ed(t,"auth");if(n.isInitialized()){const i=n.getImmediate(),s=n.getOptions();if(ul(s,e??{}))return i;Nt(i,"already-initialized")}return n.initialize({options:e})}function $C(t,e){const n=(e==null?void 0:e.persistence)||[],r=(Array.isArray(n)?n:[n]).map(Kt);e!=null&&e.errorMap&&t._updateErrorMap(e.errorMap),t._initializeWithPersistence(r,e==null?void 0:e.popupRedirectResolver)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ZN(t){Gk(Ds),ni(new ar("database",(e,{instanceIdentifier:n})=>{const r=e.getProvider("app").getImmediate(),i=e.getProvider("auth-internal"),s=e.getProvider("app-check-internal");return KN(r,i,s,n)},"PUBLIC").setMultipleInstances(!0)),Ln(rp,ip,t),Ln(rp,ip,"esm2017")}Yt.prototype.simpleListen=function(t,e){this.sendRequest("q",{p:t},e)};Yt.prototype.echo=function(t,e){this.sendRequest("echo",{d:t},e)};ZN();const eR={apiKey:"AIzaSyB4xd0DDFMNya4WYjEhjsKUUNmC8xuzpSI",authDomain:"fir-frontend-33ada.firebaseapp.com",projectId:"fir-frontend-33ada",storageBucket:"fir-frontend-33ada.appspot.com",messagingSenderId:"42334799513",appId:"1:42334799513:web:a9201fecda715da1a51a08",databaseURL:"https://fir-frontend-33ada-default-rtdb.europe-west1.firebasedatabase.app"},ly=h_(eR),Xn=jk(ly),ay=JN(ly);function tR(t,e){WN(oy(ay,"users/"+t),e)}const uy=({setBuyBtnActive:t,gamesForCart:e,setGamesForCart:n,game:r,userIsLogedIn:i})=>g("button",{onClick:()=>{let o=!1;const l=r.id;for(let a=0;a<e.length;a++){const d=e[a].id;l===d&&(o=!0)}i&&!o&&n(a=>[...a,r]),t(!0)},className:"gaming__buy-game-btn",children:"Buy"}),cy=t=>P("div",{className:"gaming__game-container",children:[P("div",{className:"gaming__game-fav-container",children:[g("div",{className:"gaming__stars-container",children:t.starIcons}),g("button",{"data-gameid":t.game.id,onClick:e=>{t.updateWishList(e)},className:"gaming__heart-btn",children:g("ion-icon",{name:"heart"})})]}),g("img",{className:"gaming__game-img",src:t.gameCover}),g("p",{className:"gaming__game-name",children:t.gameName}),P("div",{className:"gaming__game-actions-container",children:[g(Hl,{to:`/shop/${t.game.id}`,children:g("button",{className:"gaming__about-game-btn",children:"About Game"})}),g(uy,{userIsLogedIn:t.userIsLogedIn,game:t.game,gamesForCart:t.gamesForCart,setGamesForCart:t.setGamesForCart,setBuyBtnActive:t.setBuyBtnActive}),g("span",{className:"gaming__game-price",children:t.gamePrice})]})]});const dh=({cartPanelIsOpened:t,setCartPanelIsOpened:e,gamesForCart:n})=>{const r=w.useRef(null);return(()=>{r.current&&(t||n.length===0?(r.current.classList.add("hide-cart-btn"),r.current.classList.remove("display-cart-btn")):(r.current.classList.remove("hide-cart-btn"),r.current.classList.add("display-cart-btn")))})(),g("button",{ref:r,onClick:()=>{e(!0)},className:"gaming__cart-btn",children:g("ion-icon",{name:"cart"})})};const hh=({setCartPanelIsOpened:t,cartPanelIsOpened:e,gamesForCart:n,setGamesForCart:r})=>{const i=w.useRef(null);let s=0;const o=n.map(a=>{const u=a.name,d=a.price,c=parseInt(d),h=a.cover.url;s=s+c;const m=v=>{const y=v.target.dataset.gameid;let S=[];n.find(p=>{p.id!=y&&S.push(p)}),r(S)};return P("article",{className:"gaming__cart-panel-item-container",children:[g("p",{className:"gaming__cart-panel-item-text gaming__cart-panel-item-name",children:u}),P("div",{className:"gaming__cart-panel-item",children:[g("img",{src:h}),P("div",{className:"gaming__cart-panel-pqr",children:[P("p",{className:"gaming__cart-panel-item-text",children:["quantity:",g("span",{className:"gaming__cart-panel-span",children:"1"})]}),P("p",{className:"gaming__cart-panel-item-text",children:["price:",g("span",{className:"gaming__cart-panel-span",children:d})]}),g("button",{onClick:v=>{m(v)},"data-gameid":a.id,className:"gaming__cart-panel-item-remove-btn",children:"Remove"})]})]})]},Mt())});return(()=>{i.current&&(e?i.current.classList.add("opened-cart-panel"):i.current.classList.remove("opened-cart-panel"))})(),P("div",{ref:i,className:"gaming__cart-panel",children:[g("button",{onClick:()=>{t(!1)},className:"gaming__cart-panel-close-btn",children:g("ion-icon",{name:"close"})}),g("div",{className:"gaming__cart-panel-items",children:o}),P("p",{className:"gaming__cart-panel-total-price",children:["Total: ",s,"$"]})]})},nR=({wishList:t,setWishList:e,gamesForCart:n,setGamesForCart:r,setBuyBtnActive:i,userIsLogedIn:s,setWishlistBtnActive:o,games:l,cartPanelIsOpened:a,setCartPanelIsOpened:u})=>{const d=()=>t.map(m=>{const v=m.cover.url.replace("t_thumb","t_cover_big"),y=m.name.toUpperCase(),S=m.price,p=+m.starRating.slice(0,1),f=[];for(let E=0;E<p;E++)f.push(g("ion-icon",{name:"star"},Mt()));return g(cy,{game:m,starIcons:f,gameCover:v,gameName:y,gamePrice:S,gamesForCart:n,setGamesForCart:r,setBuyBtnActive:i,userIsLogedIn:s,updateWishList:E=>{if(o(!0),!s)return;E.stopPropagation();const C=E.target.parentElement,N=+C.dataset.gameid,T=l.find(L=>L.id===N);if(!T)return;C.classList.add("gaming__heart-active"),e(L=>[...L,T]);let x=!1;for(let L=0;L<t.length;L++)t[L].id==N&&(x=!0);if(x){const L=t.filter(R=>R.id!=N);e(L)}}},Mt())});w.useEffect(()=>{const h=document.querySelectorAll(".gaming__heart-btn");for(let m=0;m<h.length;m++){const v=h[m],y=v.dataset.gameid;for(let S=0;S<t.length;S++){const p=t[S].id;y==p&&v.classList.add("gaming__heart-active")}}});const c=d();return g("section",{className:"gaming__wishlist-section",children:P("main",{className:"gaming__main-container",children:[g("div",{className:"gaming__main-content",children:c}),s&&g(hh,{gamesForCart:n,setGamesForCart:r,setCartPanelIsOpened:u,cartPanelIsOpened:a}),s&&g(dh,{gamesForCart:n,cartPanelIsOpened:a,setCartPanelIsOpened:u})]})})},rR=({wishList:t,setWishList:e,gamesForCart:n,setGamesForCart:r,setBuyBtnActive:i,userIsLogedIn:s,setWishlistBtnActive:o,games:l,cartPanelIsOpened:a,setCartPanelIsOpened:u})=>g(nR,{wishList:t,setWishList:e,gamesForCart:n,setGamesForCart:r,setBuyBtnActive:i,userIsLogedIn:s,setWishlistBtnActive:o,games:l,cartPanelIsOpened:a,setCartPanelIsOpened:u}),iR=({setBuyBtnActive:t,setGamesForCart:e,setWishlistBtnActive:n,setWishList:r})=>g("button",{onClick:()=>{t(!1),n(!1),PI(Xn).then(()=>{e([])}).then(()=>{r([])}).catch(s=>{})},className:"gaming__log-out-btn",children:"Log Out"});function sR({mainMenuIsClosed:t,setMainMenuIsClosed:e,userIsLogedIn:n,setBuyBtnActive:r,setGamesForCart:i,setWishlistBtnActive:s,wishList:o,setWishList:l}){const a=w.useRef(null),u=a.current,c=ci().pathname,h=(p,f=u)=>{p==="||"&&(c==="/register"||c==="/login")&&(f.classList.remove("gaming__navbar--big-position-static"),f.classList.add("gaming__navbar--sm-position-fixed"),f.classList.add("gaming__navbar--big-position-fixed")),p==="&&"&&c!=="/register"&&c!=="/login"&&(f.classList.add("gaming__navbar--big-position-static"),f.classList.add("gaming__navbar--sm-position-fixed"),f.classList.remove("gaming__navbar--big-position-fixed"))};window.onload=()=>{const p=document.querySelector("nav");h("||",p),h("&&",p)},u!==null&&h("||"),u!==null&&h("&&");function m(){u.classList.remove("gaming__navbar-opened"),e(!0)}const y=uS().map(p=>P(sS,{className:({isActive:f})=>f?"gaming__navbar-link-active":null,to:`${p.destination}`,children:[g("ion-icon",{name:`${p.iconName}`}),P("li",{children:[p.text," ",p.text==="Wish List"?`(${o.length})`:null]})]},Mt()));return P("nav",{ref:a,className:"gaming__navbar ",children:[!n&&P("div",{className:"gaming__navbar-account",children:[g(lS,{}),g(aS,{})]}),n&&g("div",{className:"gaming__navbar-account",children:g(iR,{setGamesForCart:i,setBuyBtnActive:r,setWishlistBtnActive:s,setWishList:l})}),t?null:g("button",{onClick:m,className:"gaming__navbar-close-btn btn",children:g("img",{className:"gaming__navbar-close-icon",src:"../Assets/arrowBack.png"})}),g("ul",{children:y}),g("hr",{})]})}function oR(){return P("svg",{className:"gaming__open-nav-icon",xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 512 512",children:[g("title",{children:"Grid"}),g("rect",{x:"48",y:"48",width:"176",height:"176",rx:"20",ry:"20",fill:"none",stroke:"currentColor",strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:"32"}),g("rect",{x:"288",y:"48",width:"176",height:"176",rx:"20",ry:"20",fill:"none",stroke:"currentColor",strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:"32"}),g("rect",{x:"48",y:"288",width:"176",height:"176",rx:"20",ry:"20",fill:"none",stroke:"currentColor",strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:"32"}),g("rect",{x:"288",y:"288",width:"176",height:"176",rx:"20",ry:"20",fill:"none",stroke:"currentColor",strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:"32"})]})}function lR({mainMenuIsClosed:t,setMainMenuIsClosed:e,filterPanelIsOpened:n}){const r=w.useRef(null);function i(){if(!r.current)return;const l=document.querySelectorAll("rect"),a=document.querySelector(".gaming__navbar");r.current.classList.add("menu-shrink");let u=[0,.2,.3,.4];l.forEach((d,c)=>{n?d.style.animation=`shrink-rect-left 0.25s ${u[c]}s ease-in-out forwards`:d.style.animation=`shrink-rect-left 0.25s ${u[c]}s ease-in-out forwards`}),r.current.addEventListener("animationend",function(d){d.target===this&&(e(!1),a.classList.add("gaming__navbar-opened"))})}function s(){i()}return(()=>{r.current&&(n?(r.current.classList.remove("gaming__display-menu-btn"),r.current.classList.add("gaming__hide-menu-btn")):(r.current.classList.remove("gaming__hide-menu-btn"),r.current.classList.add("gaming__display-menu-btn")))})(),t?g("button",{ref:r,onClick:s,className:"gaming__open-nav-btn btn",children:g(oR,{})}):null}const aR=({mainMenuIsClosed:t,setMainMenuIsClosed:e,filterPanelIsOpened:n,userIsLogedIn:r,setBuyBtnActive:i,setGamesForCart:s,setWishlistBtnActive:o,wishList:l,setWishList:a})=>P(w.Fragment,{children:[g("div",{className:"gaming__menus-container",children:g(lR,{filterPanelIsOpened:n,mainMenuIsClosed:t,setMainMenuIsClosed:e})}),g(sR,{setBuyBtnActive:i,setWishlistBtnActive:o,userIsLogedIn:r,mainMenuIsClosed:t,setMainMenuIsClosed:e,setGamesForCart:s,wishList:l,setWishList:a}),g(YE,{})]});function uR(){return g("section",{className:"gaming__hero-section",children:P("div",{className:"gaming__hero-container",children:[g("img",{className:"gaming__hero-img-big",src:"../Assets/heroImg.webp"}),P("header",{children:[P("div",{className:"gaming__hero-heading-container",children:[g("img",{className:"gaming__logo",src:"../../../Assets/logo.svg"}),g("h1",{className:"gaming__hero-heading",children:"Retro Gaming"})]}),g("p",{className:"gaming__hero-text",children:"Welcome to Retro Gaming World, we specialize in selling classic and retro games for a variety of platforms, including the Nintendo Entertainment System, Super Nintendo Entertainment System, Sega Genesis, and more."}),g("p",{className:"gaming__hero-text",children:"At Retro Gaming World, we believe that every gamer should have the opportunity to experience the nostalgia and excitement of retro gaming. That's why we offer a wide selection of games at affordable prices, so you can relive your childhood memories or discover new favorites without breaking the bank. Our inventory is constantly updating, so be sure to check back often for new arrivals."}),g("button",{className:"gaming__hero-btn",children:"See Our Games"})]}),g("img",{className:"gaming__hero-img-sm",src:"../Assets/heroImg.webp"})]})})}const cR=({mainMenuIsClosed:t})=>{const[e,n]=w.useState(!1),r=w.useRef(null),[i,s]=w.useState([]);w.useEffect(()=>{(async()=>{const m=await(await fetch("http://localhost:5001/")).json();s(m)})()},[]);function o(){if(i.length===0)return;const c=i.map((h,m)=>{const v=h.imgUrl;return g("figure",{className:"gaming__feature-img-container",children:g("img",{alt:"game",src:v,className:"gaming__feature-slider-img"})})});if(e)return c;n(!0)}const l={direction:0,currentSlideIndex:0};w.useEffect(()=>{const c=document.querySelectorAll(".gaming__feature-img-container");if(!r)return;const h=c.length-1;let m=setInterval(()=>a(h,c),2500);r.current.addEventListener("mouseenter",()=>{clearInterval(m)}),r.current.addEventListener("mouseleave",()=>{m=setInterval(()=>a(h,c),2500)}),e&&(()=>{const y=c[0].getBoundingClientRect().width;for(let S=0;S<c.length;S++)c[S].style.left=`${y*S}px`})()},[e,t]);function a(c,h){l.direction-=100,l.currentSlideIndex++,l.currentSlideIndex>c&&(l.currentSlideIndex=0,l.direction=0),h.forEach(m=>{m.style.transform=`translateX(${l.direction}%)`})}function u(c,h){l.currentSlideIndex===0?(l.currentSlideIndex=c,l.direction=-`${c*100}`):l.currentSlideIndex>0&&(l.currentSlideIndex--,l.direction+=100),h.forEach(m=>{m.style.transform=`translateX(${l.direction}%)`})}const d=c=>{const h=document.querySelectorAll(".gaming__feature-img-container"),m=h.length-1;c.target.parentElement.id==="gaming__feature-move-slider-prev"?u(m,h):a(m,h)};return g(w.Fragment,{children:P("section",{className:"gaming__feature-section",children:[g("header",{className:"gaming__feature-header",children:g("h1",{className:"gaming__feature-heading",children:"The games that make you feel nostalgic"})}),P("div",{className:"gaming__feature-details-container",children:[P("div",{className:"gaming__feature-details",children:[P("div",{className:"gaming__feature-detail-container gaming__feature-variety-details",children:[g("ion-icon",{className:"gaming__feature-detail-icon",name:"infinite"}),g("p",{className:"gaming__feature-detail",children:"Large variety"}),g("p",{className:"gaming__feature-text",children:"We have 50+ games in our list from which you can choose"})]}),P("div",{className:"gaming__feature-detail-container gaming__feature-genres-details",children:[g("ion-icon",{name:"layers"}),g("p",{className:"gaming__feature-detail",children:"Different genres"}),g("p",{className:"gaming__feature-text",children:"Classic arcade games, platformers, RPGs, and more."})]}),P("div",{className:"gaming__feature-detail-container gaming__feature-about-details",children:[g("ion-icon",{name:"checkbox"}),g("p",{className:"gaming__feature-detail",children:"Carefully selected"}),g("p",{className:"gaming__feature-text",children:"Each game is carefully selected and curated to provide an authentic and nostalgic gaming experience for our users."})]})]}),P("div",{ref:r,className:"gaming__feature-slider",children:[g("button",{onClick:c=>{d(c)},id:"gaming__feature-move-slider-prev",className:"gaming__feature-move-slider-left-btn gaming__move-btn",children:g("ion-icon",{name:"arrow-back"})}),g("button",{onClick:c=>{d(c)},className:"gaming__feature-move-slider-right-btn gaming__move-btn",children:g("ion-icon",{name:"arrow-forward"})}),g("div",{className:"gaming__feature-game-cta-container",children:g("button",{className:"gaming__feature-game-page-btn",children:"See Game"})}),o()]})]})]})})};const dR=()=>g("div",{});const hR=()=>g("div",{}),fR=({mainMenuIsClosed:t,setMainMenuIsClosed:e})=>P(w.Fragment,{children:[g(uR,{mainMenuIsClosed:t,setMainMenuIsClosed:e}),g(cR,{mainMenuIsClosed:t}),g(dR,{}),g(hR,{})]});const pR=({setFilteredGamesBySearchBar:t,games:e})=>{const n=i=>{let s=[];const o=i.target.value.toLowerCase(),l=o.length;if(o===""&&(s=[],t(s)),!(e.length===0||!o)){for(let a=0;a<e.length;a++){const u=e[a],d=u.name.toLowerCase();o===d.slice(0,l)&&s.push(u)}t(s)}},r=w.useRef(null);return P("div",{ref:r,className:"gaming__searchbar",children:[g("input",{onChange:i=>{n(i)},placeholder:"Search Game",onFocus:()=>{r.current.classList.add("add-shadow")},onBlur:()=>{r.current.classList.remove("add-shadow")},className:"gaming__searchbar-input",type:"text"}),g("ion-icon",{name:"search"})]})};const mR=({setFilterPanelIsOpened:t,setOpenFilterBtnRef:e})=>{const n=w.useRef(null);return g("button",{ref:n,onClick:()=>{n.current.classList.remove("gaming__display-open-btn"),n.current.classList.add("gaming__hide-open-btn"),t(!0),n.current&&e(n)},className:"gaming__open-filter",children:g("ion-icon",{name:"search"})})};const Ja=({updateFilter:t,genresLists:e,ratingLists:n,priceLists:r,getRefForFilters:i,criterion:s,filtersToBeDisplayedRefs:o,ulListsAreOpened:l,setUlListsAreOpened:a,tabWasClickedTwice:u,setTabWasClickedTwice:d,numOfOpenLists:c,setNumOfOpenLists:h,currentTab:m,setCurrentTab:v})=>{const y=w.useRef(null);i(y);const S=f=>{f.stopPropagation();const _=f.target.nextElementSibling===null?f.target.parentElement.nextElementSibling:f.target.nextElementSibling;let E=_.dataset.ulType;v(E),a(C=>({...C,[E]:!C[E]}));for(let C=0;C<o.length;C++)if(o.length>0){if(_===o[C].current)continue;o[C].current.classList.remove("gaming__filter-ul-visible-delayed"),o[C].current.classList.add("gaming__filter-ul-hidden")}c===2?y.current&&(y.current.classList.toggle("gaming__filter-ul-hidden"),y.current.classList.add("gaming__filter-ul-visible-delayed")):y.current&&y.current.classList.toggle("gaming__filter-ul-hidden"),u[E]&&y.current.classList.remove("gaming__filter-ul-visible-delayed");for(const C in l)C!==E&&a(N=>({...N,[C]:!1}))};w.useEffect(()=>{h(1);for(const f in l)l[f]&&h(_=>_+1)},[l]),w.useEffect(()=>{if(m){for(const f in u)m!==f&&d(_=>({..._,[f]:!1}));d(f=>({...f,[m]:!0}))}},[m]);let p;switch(s){case"Genres":p=e;break;case"Rating":p=n;break;case"Price":p=r}return P("div",{className:"gaming__filter-inner-container",children:[g("div",{onClick:S,className:"gaming__filter-name",children:P("p",{children:[" ",s]})}),g("ul",{"data-ul-type":s,onClick:f=>{t(f)},ref:y,className:"gaming__filter-ul-visible gaming__filter-ul-hidden",children:p})]})};const gR=({setFilterPanelIsOpened:t,openFilterBtnRef:e})=>g("button",{onClick:()=>{e.current.classList.remove("gaming__hide-open-btn"),e.current.classList.add("gaming__display-open-btn"),t(!1)},className:"gaming__close-filter",children:g("ion-icon",{name:"close"})}),_R=({filterPanelIsOpened:t,setFilterPanelIsOpened:e,games:n,openFilterBtnRef:r,setOpenFilterBtnRef:i,pageContents:s,setPageContents:o,numberOfPages:l,displayOverlayGamesNotFound:a,setDisplayOverlayGamesNotFound:u,areInitialNumberOfPages:d,setAreInitialNumberOfPages:c,setCartPanelIsOpened:h,cartPanelIsOpened:m,setBuyBtnActive:v,gamesForCart:y,setGamesForCart:S,userIsLogedIn:p,wishList:f,setWishList:_,setWishlistBtnActive:E})=>{const[C,N]=w.useState([]),[T,x]=w.useState({}),[L,R]=w.useState(0),[q,Ut]=w.useState([]),[fe,_e]=w.useState([]),[me,Ue]=w.useState([]),[ot,O]=w.useState([]),[b,U]=w.useState(null),[Z,le]=w.useState(null),[Bt,lt]=w.useState({Genres:!1,Rating:!1,Price:!1}),[an,at]=w.useState({Genres:!1,Rating:!1,Price:!1}),[zt,Ks]=w.useState(1),qs=w.useRef(null),my=["1 star","2 stars","3 stars","4 stars","5 stars"],gy=["10$","15$","20$","22$"];w.useEffect(()=>{(async()=>{const V=await(await fetch("http://localhost:5002")).json();N(V)})()},[]);const _y=B=>{if(!B.target.closest(".gaming__filter-ul-visible")){Ks(1),le(null),lt({Genres:!1,Rating:!1,Price:!1}),at({Genres:!1,Rating:!1,Price:!1});for(let D=0;D<ot.length;D++)ot[D].current.classList.add("gaming__filter-ul-hidden"),ot[D].current.classList.remove("gaming__filter-ul-visible-delayed")}},sa=(B,D)=>B.map((V,Y)=>P("li",{children:[V,g("input",{"data-i":Y,"data-filter-item":V,"data-filter-type":D,type:"checkbox"})]},Mt())),vy=sa(C,"genre"),yy=sa(my,"rating"),wy=sa(gy,"price"),oa=B=>{R(0);const D=B.target,V=D.checked;if(D.nodeName!="INPUT")return;const Y=[D.dataset.filterItem],G=D.dataset.filterType,ee=[+D.dataset.i],Oe=(mt,Rt)=>{mt(Be=>{let Wt;return V?Wt=Array.isArray(Be[G])?Be[G]:[]:Wt=[],{...Be,[G]:[...Wt,...Rt]}})};if(!V){const mt=me[G].filter(Be=>Be!==ee[0]),Rt=T[G].filter(Be=>Be!==Y[0]);Oe(x,Rt),Oe(Ue,mt)}T[G]&&T[G].includes(Y[0])||(Oe(x,Y),Oe(Ue,ee))};w.useEffect(()=>{(()=>{if(n.length===0)return;let D=[],V;for(let Y=0;Y<n.length;Y++){V=null;const G=n[Y],ee=G.genres,Oe=G.starRating,mt=G.price,Rt={genre:[],rating:[],price:[]};if(ee){if(T.hasOwnProperty("genre"))for(let Be=0;Be<ee.length;Be++){const Wt=ee[Be].name;Rt.genre.push(Wt)}T.hasOwnProperty("rating")&&Rt.rating.push(Oe),T.hasOwnProperty("price")&&Rt.price.push(mt);for(const Be in T){if(V===!1)break;for(let Wt=0;Wt<T[Be].length;Wt++)if(Rt[Be].includes(T[Be][Wt]))V=!0;else{V=!1;break}}V&&D.push(G)}}Ut(D)})()},[n,me]),w.useEffect(()=>{const B=document.querySelectorAll("input[data-filter-item]");let D={};for(const V in me){D[V]||(D[V]=[]);for(let Y=0;Y<B.length;Y++)for(let G=0;G<me[V].length;G++)+B[Y].dataset.i===me[V][G]&&B[Y].dataset.filterType===V&&(D[V].includes(B[Y])||D[V].push(B[Y]));D[V].forEach(Y=>{Y.setAttribute("checked","")})}},[me,L,q,s,t,a,d,b,zt,Bt,an,Z,fe]),(()=>{qs.current&&(t?qs.current.classList.add("gaming__filter-opened"):qs.current.classList.remove("gaming__filter-opened"))})(),w.useEffect(()=>()=>{e(!1)},[]);const la=(B=n)=>{let D=[];const Y=Math.ceil(B.length/40);B===n&&c(!0),Y||u(!0);let G=0;for(let ee=0;ee<Y;ee++){D.push([]),ee===0?G=0:G=G+40-1,ee>0&&(G+=1);for(let Oe=G;Oe<B.length;Oe++){const mt=D[ee],Rt=B[Oe];mt.length!=40&&mt.push(Rt)}}o(D)};w.useEffect(()=>{const B=n.length>0;let D;for(const V in T)if(T[V].length>0){D=!0;break}B&&!D&&fe.length===0?la():la(D?q:fe)},[q,fe]);const Ey=()=>{L!==0&&R(B=>B-1)},Sy=()=>{L>l-2||R(B=>B+1)},Cy=B=>{let D=B.target.value;D>=0&&D<=l-1&&R(+D)},Iy=B=>{if(E(!0),!p)return;B.stopPropagation();const D=B.target.parentElement,V=+D.dataset.gameid,Y=n.find(ee=>ee.id===V);if(!Y)return;D.classList.add("gaming__heart-active"),_(ee=>[...ee,Y]);let G=!1;for(let ee=0;ee<f.length;ee++)f[ee].id==V&&(G=!0);if(G){const ee=f.filter(Oe=>Oe.id!=V);_(ee)}},fh=(()=>s.length>0&&L>=0&&s[L].map(D=>{const V=D.cover.url.replace("t_thumb","t_cover_big"),Y=D.name.toUpperCase(),G=D.price,ee=+D.starRating.slice(0,1),Oe=[];for(let mt=0;mt<ee;mt++)Oe.push(g("ion-icon",{name:"star"},Mt()));return g(cy,{gameCover:V,gameName:Y,gamePrice:G,starIcons:Oe,game:D,userIsLogedIn:p,gamesForCart:y,setGamesForCart:S,setBuyBtnActive:v,updateWishList:Iy},Mt())}))();w.useEffect(()=>{const B=document.querySelectorAll(".gaming__heart-btn");for(let D=0;D<B.length;D++){const V=B[D],Y=V.dataset.gameid;for(let G=0;G<f.length;G++){if(!f[G])continue;const ee=f[G].id;Y==ee&&V.classList.add("gaming__heart-active")}}},[f,fh]),w.useEffect(()=>{U(document.querySelector(".gaming__menus-container"))},[]);const ky=b&&tE.createPortal(g(mR,{setFilterPanelIsOpened:e,setOpenFilterBtnRef:i}),b),aa=B=>{w.useEffect(()=>{O(D=>[...D,B])},[])};return P("section",{onClick:B=>{_y(B)},className:"gaming__shop-section",children:[P("div",{ref:qs,className:"gaming__filter-container",children:[P("div",{className:"gaming__searchbar-container",children:[g(pR,{games:n,setFilteredGamesBySearchBar:_e}),g(gR,{openFilterBtnRef:r,setFilterPanelIsOpened:e})]}),g("p",{children:"Filter By:"}),P("div",{className:"gaming__filters",children:[g(Ja,{criterion:"Genres",updateFilter:oa,genresLists:vy,getRefForFilters:aa,filtersToBeDisplayedRefs:ot,ulListsAreOpened:Bt,setUlListsAreOpened:lt,tabWasClickedTwice:an,setTabWasClickedTwice:at,numOfOpenLists:zt,setNumOfOpenLists:Ks,currentTab:Z,setCurrentTab:le}),g(Ja,{criterion:"Rating",updateFilter:oa,ratingLists:yy,getRefForFilters:aa,filtersToBeDisplayedRefs:ot,ulListsAreOpened:Bt,setUlListsAreOpened:lt,tabWasClickedTwice:an,setTabWasClickedTwice:at,numOfOpenLists:zt,setNumOfOpenLists:Ks,currentTab:Z,setCurrentTab:le}),g(Ja,{criterion:"Price",updateFilter:oa,priceLists:wy,getRefForFilters:aa,filtersToBeDisplayedRefs:ot,ulListsAreOpened:Bt,setUlListsAreOpened:lt,tabWasClickedTwice:an,setTabWasClickedTwice:at,numOfOpenLists:zt,setNumOfOpenLists:Ks,currentTab:Z,setCurrentTab:le})]}),P("div",{className:"gaming__mobile-pages",children:[g("p",{className:"gaming__mobile-pages-text",children:"Go to page:"}),g("button",{onClick:Ey,className:"gaming__mobile-pages-prev",children:g("ion-icon",{name:"remove"})}),g("input",{value:L.toString(),onChange:B=>{Cy(B)},className:"gaming__mobile-pages-input",type:"number"}),g("button",{onClick:Sy,className:"gaming__mobile-pages-next",children:g("ion-icon",{name:"add"})}),g("span",{className:"gaming__mobile-pages-span",children:"/"}),g("span",{className:"gaming__mobile-pages-span",children:l-1})]})]}),p&&g(hh,{gamesForCart:y,setGamesForCart:S,setCartPanelIsOpened:h,cartPanelIsOpened:m}),p&&g(dh,{gamesForCart:y,cartPanelIsOpened:m,setCartPanelIsOpened:h}),g("main",{className:"gaming__main-container",children:g("div",{className:"gaming__main-content",children:fh})}),ky]})},vR=({filterPanelIsOpened:t,setFilterPanelIsOpened:e,games:n,openFilterBtnRef:r,setOpenFilterBtnRef:i,pageContents:s,setPageContents:o,numberOfPages:l,displayOverlayGamesNotFound:a,setDisplayOverlayGamesNotFound:u,areInitialNumberOfPages:d,setAreInitialNumberOfPages:c,setGameId:h,setCartPanelIsOpened:m,cartPanelIsOpened:v,setBuyBtnActive:y,gamesForCart:S,setGamesForCart:p,userIsLogedIn:f,wishList:_,setWishList:E,setWishlistBtnActive:C})=>g(_R,{pageContents:s,setPageContents:o,numberOfPages:l,openFilterBtnRef:r,setOpenFilterBtnRef:i,games:n,filterPanelIsOpened:t,setFilterPanelIsOpened:e,displayOverlayGamesNotFound:a,setDisplayOverlayGamesNotFound:u,areInitialNumberOfPages:d,setAreInitialNumberOfPages:c,setGameId:h,setCartPanelIsOpened:m,cartPanelIsOpened:v,setBuyBtnActive:y,gamesForCart:S,setGamesForCart:p,userIsLogedIn:f,wishList:_,setWishList:E,setWishlistBtnActive:C});const yR=()=>(w.useEffect(()=>{let t;async function e(){const n={lat:45.7589515,lng:21.2194093},{Map:r}=await google.maps.importLibrary("maps"),{AdvancedMarkerView:i}=await google.maps.importLibrary("marker");t=new r(document.getElementById("map"),{zoom:13,center:n,mapId:"contact_map"}),new i({map:t,position:n,title:"Timisoara"})}e()},[]),g("div",{className:"test",id:"map"}));const wR=()=>g("section",{className:"gaming__contact-section",children:P("main",{className:"gaming__contact-main-content",children:[g("div",{className:"gaming__contact-details-container",children:P("ul",{className:"gaming__contact-details-ul",children:[P("li",{children:[g("span",{children:"Phone Number:"})," 07xx-xxx-xxx"]}),P("li",{children:[g("span",{children:"Email:"})," someRandomMail@gmail.com"]}),P("li",{children:[g("span",{children:"Location:"})," Some location"]})]})}),g(yR,{})]})}),ER=()=>g(w.Fragment,{children:g(wR,{})}),dy=(t,e=300)=>{let n;return(...r)=>{clearTimeout(n),n=setTimeout(()=>{t.apply(globalThis,r)},e)}},hy=({setUserEmail:t})=>{const e=dy(n=>{t(n.target.value)});return g("input",{onChange:e,placeholder:"email",className:"gaming__account-form-input",type:"email"})},fy=({validatePassword:t,userPassword:e,setUserPassword:n})=>{const r=dy(i=>{n(i.target.value)});return w.useEffect(()=>{t&&t(e)},[e]),g("input",{onChange:i=>{r(i)},placeholder:"pass",className:"gaming__account-form-input",type:"password"})};const SR=()=>{const[t,e]=w.useState(""),[n,r]=w.useState("");return g("div",{className:"gaming__account-container",children:P("form",{onSubmit:async s=>{s.preventDefault();try{const l=(await kI(Xn,t,n)).user}catch(o){console.log(o)}},className:"gaming__account-form",children:[g(hy,{setUserEmail:e}),g(fy,{setUserPassword:r}),g("button",{type:"submit",className:"gaming__account-login-btn",children:"Log In"})]})})};const py=({redirectSecondsFromLogin:t,redirectSecondsFromRegister:e})=>P("div",{className:"gaming__redirect-to-shop-overlay",children:[t&&P("p",{className:"gaming__redirect-to-shop-overlay-text",children:["You will be redirected to the shoping page in"," ",t," ",t===1?"second":"seconds"]}),e&&P("p",{className:"gaming__redirect-to-shop-overlay-text",children:["You will be redirected to the shoping page in"," ",e," ",e===1?"second":"seconds"]})]}),CR=({userIsLogedIn:t})=>{const[e,n]=w.useState(3),r=fd();return w.useEffect(()=>{e===0&&r("/shop"),!(!t||e===0)&&setTimeout(()=>{n(i=>i-1)},1e3)},[t,e]),P(w.Fragment,{children:[!t&&g("section",{className:"gaming__login-section",children:g(SR,{})}),t&&e&&g(py,{redirectSecondsFromLogin:e})]})},IR=()=>{const t={hasNumber:!1,hasUpperCase:!1,hasSpecialChar:!1,minPassLength:7},[e,n]=w.useState(""),[r,i]=w.useState(""),[s,o]=w.useState(t),l=(d,c)=>{o(h=>({...h,[d]:c}))},a=d=>{const c=["!","@","#","$","%","&","'","(",")","*","+",",","-",".","/",":",";","<","=",">","?","@","[","\\","]","^","_","`","{","|","}","~"];for(let v=0;v<d.length;v++){const y=d[v],S=Number(y),p=c.some(function(f){return y===f});S&&l("hasNumber",!0),y===y.toUpperCase()&&!S&&!p&&l("hasUpperCase",!0),p&&l("hasSpecialChar",!0)}const h=()=>{c.some(function(y){return d.includes(y)})||l("hasSpecialChar",!1)},m=(v,y,S)=>{v.test(d)||l(y,S)};return m(/\d/,"hasNumber",!1),m(/[A-Z]/,"hasUpperCase",!1),h(),!!(s.hasNumber&&s.hasUpperCase&&s.hasSpecialChar)};return g("div",{className:"gaming__account-container",children:P("form",{onSubmit:async d=>{if(!(r.length<t.minPassLength)&&a(r)){d.preventDefault();try{const c=await II(Xn,e,r)}catch(c){console.log(c.message)}}},className:"gaming__account-form",children:[g(hy,{setUserEmail:n}),g(fy,{validatePassword:a,userPassword:r,setUserPassword:i}),g("button",{className:"gaming__account-register-btn",children:"Create Account"}),g("div",{className:"gaming__account-validation",children:P("ul",{children:[P("li",{className:`gaming__account-validation-li-${s.hasUpperCase?"correct":"wrong"}`,children:[g("span",{children:"→"}),"atleast one upper case character;"]}),P("li",{className:`gaming__account-validation-li-${s.hasNumber?"correct":"wrong"}`,children:[g("span",{children:"→"})," atleast one number character;"]}),P("li",{className:`gaming__account-validation-li-${s.hasSpecialChar?"correct":"wrong"}`,children:[g("span",{children:"→"})," atleast one special character;"]}),P("li",{className:`gaming__account-validation-li-${r.length>=s.minPassLength?"correct":"wrong"}`,children:[g("span",{children:"→"}),"password length must be atleast 7;"]})]})})]})})};const kR=({userIsLogedIn:t})=>{const e=fd(),[n,r]=w.useState(3);return w.useEffect(()=>{n===0&&e("/shop"),!(!t||n===0)&&setTimeout(()=>{r(i=>i-1)},1e3)},[t,n]),P(w.Fragment,{children:[!t&&g("section",{className:"gaming__register-section",children:g(IR,{})}),t&&n&&g(py,{redirectSecondsFromRegister:n})]})};const TR=({numberOfPages:t,displayOverlayGamesNotFound:e,setDisplayOverlayGamesNotFound:n})=>{const r=w.useRef(null),i=window.location.pathname;return g(w.Fragment,{children:!t&&i==="/shop"&&e&&g("div",{ref:r,className:"gaming__games-not-found-overlay",children:P("div",{className:"gaming__games-not-found-overlay-container",children:[g("p",{className:"gaming__games-not-found-message",children:"We didn't find any games to match your query"}),g("button",{className:"gaming__games-not-found-close-overlay-btn",onClick:()=>n(!1),children:"OK"})]})})})};const NR=()=>g("a",{href:"/login",className:"gaming__redirect-to-login-btn",children:"Log In"});const RR=()=>g("a",{href:"/register",className:"gaming__redirect-to-register-btn",children:"Create account"});const PR=({setBuyBtnActive:t,setWishlistBtnActive:e})=>g("button",{onClick:()=>{e(!1),t(!1)},className:"gaming__close-redirect-overlay-btn",children:g("ion-icon",{name:"close"})});const xR=({buyBtnActive:t,setBuyBtnActive:e,wishlistBtnActive:n,setWishlistBtnActive:r})=>g("div",{onClick:()=>{r(!1),e(!1)},className:"gaming__redirect-to-account-backdrop-shadow",children:P("div",{className:"gaming__redirect-to-account-overlay-container",children:[g(PR,{setWishlistBtnActive:r,setBuyBtnActive:e}),P("p",{className:"gaming__redirect-to-account-text",children:["To ",t&&"purchase",n&&"list that game"," please log in or create an account."]}),P("div",{className:"gaming__redirect-to-account-overlay-btns-container",children:[g(NR,{}),g(RR,{})]})]})}),OR=({areInitialNumberOfPages:t,numberOfPages:e,displayOverlayGamesNotFound:n,setDisplayOverlayGamesNotFound:r,userIsLogedIn:i,buyBtnActive:s,setBuyBtnActive:o,wishlistBtnActive:l,setWishlistBtnActive:a})=>P(w.Fragment,{children:[t&&g(TR,{numberOfPages:e,displayOverlayGamesNotFound:n,setDisplayOverlayGamesNotFound:r}),!i&&(s||l)&&g(xR,{wishlistBtnActive:l,setWishlistBtnActive:a,buyBtnActive:s,setBuyBtnActive:o})]});const AR=({userIsLogedIn:t,setSelectedTab:e,gamesForCart:n,setGamesForCart:r,game:i,setBuyBtnActive:s})=>{const o=w.useRef(null),l=w.useRef(null);return g(w.Fragment,{children:P("div",{className:"gaming__current-game-selections-container",children:[g("button",{ref:o,onClick:a=>{a.target.classList.add("selected-btn"),l.current.classList.remove("selected-btn"),e("about")},className:"gaming__current-game-selection-btn selected-btn",children:"About game"}),g("button",{ref:l,onClick:a=>{a.target.classList.add("selected-btn"),o.current.classList.remove("selected-btn"),e("screenshots")},className:"gaming__current-game-selection-btn",children:"Screenshots"}),g(uy,{userIsLogedIn:t,setBuyBtnActive:s,game:i,gamesForCart:n,setGamesForCart:r})]})})},LR=({userIsLogedIn:t,games:e,cartPanelIsOpened:n,setCartPanelIsOpened:r,gamesForCart:i,setGamesForCart:s,setBuyBtnActive:o})=>{const l=()=>{const[a,u]=w.useState("about");let d;const h=window.location.pathname.split("/"),m=+h[h.length-1];for(let R=0;R<e.length;R++){const q=e[R];q.id===m&&(d=q)}if(!d)return;const v=d.cover.url.replace("t_thumb","t_720p"),y=+d.starRating.slice(0,1),S=new Date(d.first_release_date*1e3),p=S.toLocaleString("default",{month:"short"}),f=S.getFullYear(),_=S.getDate();let E=[];if(d.screenshots)for(let R=0;R<d.screenshots.length;R++){const q=d.screenshots[R].url;E.push(q)}const C=E.map(R=>g("li",{children:g("img",{src:R})},Mt()));let N=[];for(let R=0;R<y;R++)N.push(g("ion-icon",{name:"star"},Mt()));let T=[];for(let R=0;R<d.genres.length;R++){const q=" "+d.genres[R].name;T.push(q)}let x=[];for(let R=0;R<d.platforms.length;R++){const q=d.platforms[R].abbreviation;q&&x.push(q)}const L=x.map(R=>g("li",{children:R},Mt()));return P(w.Fragment,{children:[P("div",{className:"gaming__current-game-details-container",children:[g("img",{className:"gaming__current-game-img",src:v}),g("div",{className:"gaming__current-game-overlay"}),g(AR,{userIsLogedIn:t,game:d,setBuyBtnActive:o,gamesForCart:i,setGamesForCart:s,setSelectedTab:u})]}),a==="about"&&g("div",{className:"gaming__current-game-about-container",children:P("ul",{className:"gaming__current-game-selection-details-ul",children:[P("li",{className:"gaming__current-game-detail",children:[g("span",{children:"Game name:"})," "+d.name]}),P("li",{className:"gaming__current-game-detail",children:[g("span",{children:"Genres:"})," "+T.join(",")]}),P("li",{className:"gaming__current-game-detail",children:[g("span",{children:"Rating:"})," ",N]}),P("li",{className:"gaming__current-game-detail",children:[g("span",{children:"Release date:"})," "+p,"/",_,"/",f]}),P("li",{className:"gaming__current-game-detail-platforms",children:[g("p",{children:"Supported platforms:"}),g("ul",{className:"gaming__current-game-platforms",children:L})]})]})}),a==="about"&&P("p",{className:"gaming__current-game-detail-summary",children:[g("span",{children:"Game description :"})," ",d.summary]}),a==="screenshots"&&g("div",{className:"gaming__current-game-screenshots-container",children:C})]})};return w.useEffect(()=>{r(!1)},[]),P("section",{className:"gaming__current-game-details-section",children:[g("main",{children:l()}),g(hh,{setGamesForCart:s,gamesForCart:i,cartPanelIsOpened:n,setCartPanelIsOpened:r}),g(dh,{gamesForCart:i,cartPanelIsOpened:n,setCartPanelIsOpened:r})]})};function DR(){const[t,e]=w.useState(!0),[n,r]=w.useState(!1),[i,s]=w.useState(!1),[o,l]=w.useState([]),[a,u]=w.useState([]),d=a.length>0&&a.length,[c,h]=w.useState(null),[m,v]=w.useState(!0),[y,S]=w.useState(null),[p,f]=w.useState(!1),[_,E]=w.useState(!1),[C,N]=w.useState(!1),[T,x]=w.useState([]),[L,R]=w.useState([]);w.useEffect(()=>{RI(Xn,fe=>{f(!!fe)})});const q=[...o];w.useEffect(()=>{(async()=>{const me=await(await fetch("http://localhost:5000")).json();l(me)})()},[]),w.useEffect(()=>{if(!p)return;const fe=Xn.currentUser&&Xn.currentUser.uid,_e=oy(ay,"users/"+fe);jN(_e,me=>{const Ue=me.val(),ot=Ue&&Ue.gamesForWishList,O=JSON.parse(ot);Ue&&Ue.gamesForWishList&&R(O);const b=Ue&&Ue.gamesForCart,U=JSON.parse(b);Ue&&Ue.gamesForCart&&x(U)})},[p]),w.useEffect(()=>{if(!p)return;const fe=Xn.currentUser.uid;tR(fe,{gamesForCart:JSON.stringify(T),gamesForWishList:JSON.stringify(L)})},[T,L]);const Ut=()=>{for(let fe=0;fe<q.length;fe++){const _e=q[fe],me=_e.rating;me<=20?(_e.starRating="1 star",_e.price="10$"):me>20&&me<=40?(_e.starRating="2 stars",_e.price="10$"):me>40&&me<=60?(_e.starRating="3 stars",_e.price="15$"):me>60&&me<=80?(_e.starRating="4 stars",_e.price="20$"):(_e.starRating="5 stars",_e.price="22$")}};return q.length>0&&Ut(),w.useEffect(()=>{l(q)},[]),P(w.Fragment,{children:[g(OR,{buyBtnActive:_,setBuyBtnActive:E,userIsLogedIn:p,areInitialNumberOfPages:y,numberOfPages:d,displayOverlayGamesNotFound:m,setDisplayOverlayGamesNotFound:v,wishlistBtnActive:C,setWishlistBtnActive:N}),g(rS,{children:g(XE,{children:P(xt,{path:"/",element:g(aR,{setBuyBtnActive:E,setWishlistBtnActive:N,userIsLogedIn:p,setOpenFilterBtnRef:h,setFilterPanelIsOpened:r,filterPanelIsOpened:n,mainMenuIsClosed:t,setMainMenuIsClosed:e,setGamesForCart:x,wishList:L,setWishList:R}),children:[g(xt,{index:!0,element:g(fR,{mainMenuIsClosed:t,setMainMenuIsClosed:e})}),g(xt,{path:"/shop",element:g(vR,{pageContents:a,setPageContents:u,numberOfPages:d,openFilterBtnRef:c,setOpenFilterBtnRef:h,games:o,filterPanelIsOpened:n,setFilterPanelIsOpened:r,displayOverlayGamesNotFound:m,setDisplayOverlayGamesNotFound:v,areInitialNumberOfPages:y,setAreInitialNumberOfPages:S,setCartPanelIsOpened:s,cartPanelIsOpened:i,setBuyBtnActive:E,gamesForCart:T,setGamesForCart:x,userIsLogedIn:p,wishList:L,setWishList:R,setWishlistBtnActive:N})}),g(xt,{path:"/shop/:gameId",element:g(LR,{userIsLogedIn:p,cartPanelIsOpened:i,setCartPanelIsOpened:s,games:o,gamesForCart:T,setGamesForCart:x,setBuyBtnActive:E})}),g(xt,{path:"wishlist",element:g(rR,{gamesForCart:T,setGamesForCart:x,wishList:L,setWishList:R,setBuyBtnActive:E,userIsLogedIn:p,setWishlistBtnActive:N,games:o,cartPanelIsOpened:i,setCartPanelIsOpened:s})}),g(xt,{path:"contact",element:g(ER,{})}),g(xt,{path:"login",element:g(CR,{userIsLogedIn:p})}),g(xt,{path:"register",element:g(kR,{userIsLogedIn:p})}),g(xt,{path:"*",element:g(Error,{})})]})})})]})}Za.createRoot(document.getElementById("root")).render(g(DR,{}));
