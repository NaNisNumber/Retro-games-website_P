 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const q1=Math.log(2);class Q1{constructor(e){const n=s=>parseInt(Math.log(s)/q1,10),r=s=>parseInt(Array(s+1).join("1"),2);this.count=n(e+1),this.current_=this.count-1;const i=r(this.count);this.bits_=e+1&i}nextBitIsOne(){const e=!(this.bits_&1<<this.current_);return this.current_--,e}}const _l=function(t,e,n,r){t.sort(e);const i=function(a,u){const c=u-a;let d,h;if(c===0)return null;if(c===1)return d=t[a],h=n?n(d):d,new Ie(h,d.node,Ie.BLACK,null,null);{const g=parseInt(c/2,10)+a,v=i(a,g),y=i(g+1,u);return d=t[g],h=n?n(d):d,new Ie(h,d.node,Ie.BLACK,v,y)}},s=function(a){let u=null,c=null,d=t.length;const h=function(v,y){const C=d-v,p=d;d-=v;const f=i(C+1,p),m=t[C],E=n?n(m):m;g(new Ie(E,m.node,y,null,f))},g=function(v){u?(u.left=v,u=v):(c=v,u=v)};for(let v=0;v<a.count;++v){const y=a.nextBitIsOne(),C=Math.pow(2,a.count-(v+1));y?h(C,Ie.BLACK):(h(C,Ie.BLACK),h(C,Ie.RED))}return c},o=new Q1(t.length),l=s(o);return new Ke(r||e,l)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ZN(t){Gk(Ds),ni(new ar("database",(e,{instanceIdentifier:n})=>{const r=e.getProvider("app").getImmediate(),i=e.getProvider("auth-internal"),s=e.getProvider("app-check-internal");return KN(r,i,s,n)},"PUBLIC").setMultipleInstances(!0)),Ln(rp,ip,t),Ln(rp,ip,"esm2017")}Yt.prototype.simpleListen=function(t,e){this.sendRequest("q",{p:t},e)};Yt.prototype.echo=function(t,e){this.sendRequest("echo",{d:t},e)};ZN();const eR={apiKey:"AIzaSyB4xd0DDFMNya4WYjEhjsKUUNmC8xuzpSI",authDomain:"fir-frontend-33ada.firebaseapp.com",projectId:"fir-frontend-33ada",storageBucket:"fir-frontend-33ada.appspot.com",messagingSenderId:"42334799513",appId:"1:42334799513:web:a9201fecda715da1a51a08",databaseURL:"https://fir-frontend-33ada-default-rtdb.europe-west1.firebasedatabase.app"},ly=h_(eR),Xn=jk(ly),ay=JN(ly);function tR(t,e){WN(oy(ay,"users/"+t),e)}const uy=({setBuyBtnActive:t,gamesForCart:e,setGamesForCart:n,game:r,userIsLogedIn:i})=>_("button",{onClick:()=>{let o=!1;const l=r.id;for(let a=0;a<e.length;a++){const c=e[a].id;l===c&&(o=!0)}i&&!o&&n(a=>[...a,r]),t(!0)},className:"gaming__buy-game-btn",children:"Buy"}),cy=t=>A("div",{className:"gaming__game-container",children:[A("div",{className:"gaming__game-fav-container",children:[_("div",{className:"gaming__stars-container",children:t.starIcons}),_("button",{"data-gameid":t.game.id,onClick:e=>{t.updateWishList(e)},className:"gaming__heart-btn",children:_("ion-icon",{name:"heart"})})]}),_("img",{className:"gaming__game-img",src:t.gameCover}),_("p",{className:"gaming__game-name",children:t.gameName}),A("div",{className:"gaming__game-actions-container",children:[_(Hl,{to:`/shop/${t.game.id}`,children:_("button",{className:"gaming__about-game-btn",children:"About Game"})}),_(uy,{userIsLogedIn:t.userIsLogedIn,game:t.game,gamesForCart:t.gamesForCart,setGamesForCart:t.setGamesForCart,setBuyBtnActive:t.setBuyBtnActive}),_("span",{className:"gaming__game-price",children:t.gamePrice})]})]});const dh=({cartPanelIsOpened:t,setCartPanelIsOpened:e,gamesForCart:n})=>{const r=w.useRef(null);return(()=>{r.current&&(t||n.length===0?(r.current.classList.add("hide-cart-btn"),r.current.classList.remove("display-cart-btn")):(r.current.classList.remove("hide-cart-btn"),r.current.classList.add("display-cart-btn")))})(),_("button",{ref:r,onClick:()=>{e(!0)},className:"gaming__cart-btn",children:_("ion-icon",{name:"cart"})})};const hh=({setCartPanelIsOpened:t,cartPanelIsOpened:e,gamesForCart:n,setGamesForCart:r})=>{const i=w.useRef(null);let s=0;const o=n.map(a=>{const u=a.name,c=a.price,d=parseInt(c),h=a.cover.url;s=s+d;const g=v=>{const y=v.target.dataset.gameid;let C=[];n.find(p=>{p.id!=y&&C.push(p)}),r(C)};return A("article",{className:"gaming__cart-panel-item-container",children:[_("p",{className:"gaming__cart-panel-item-text gaming__cart-panel-item-name",children:u}),A("div",{className:"gaming__cart-panel-item",children:[_("img",{src:h}),A("div",{className:"gaming__cart-panel-pqr",children:[A("p",{className:"gaming__cart-panel-item-text",children:["quantity:",_("span",{className:"gaming__cart-panel-span",children:"1"})]}),A("p",{className:"gaming__cart-panel-item-text",children:["price:",_("span",{className:"gaming__cart-panel-span",children:c})]}),_("button",{onClick:v=>{g(v)},"data-gameid":a.id,className:"gaming__cart-panel-item-remove-btn",children:"Remove"})]})]})]},Mt())});return(()=>{i.current&&(e?i.current.classList.add("opened-cart-panel"):i.current.classList.remove("opened-cart-panel"))})(),A("div",{ref:i,className:"gaming__cart-panel",children:[_("button",{onClick:()=>{t(!1)},className:"gaming__cart-panel-close-btn",children:_("ion-icon",{name:"close"})}),_("div",{className:"gaming__cart-panel-items",children:o}),A("p",{className:"gaming__cart-panel-total-price",children:["Total: ",s,"$"]})]})},nR=({wishList:t,setWishList:e,gamesForCart:n,setGamesForCart:r,setBuyBtnActive:i,userIsLogedIn:s,setWishlistBtnActive:o,games:l,cartPanelIsOpened:a,setCartPanelIsOpened:u})=>{const c=()=>t.map(g=>{const v=g.cover.url.replace("t_thumb","t_cover_big"),y=g.name.toUpperCase(),C=g.price,p=+g.starRating.slice(0,1),f=[];for(let E=0;E<p;E++)f.push(_("ion-icon",{name:"star"},Mt()));return _(cy,{game:g,starIcons:f,gameCover:v,gameName:y,gamePrice:C,gamesForCart:n,setGamesForCart:r,setBuyBtnActive:i,userIsLogedIn:s,updateWishList:E=>{if(o(!0),!s)return;E.stopPropagation();const S=E.target.parentElement,N=+S.dataset.gameid,T=l.find(L=>L.id===N);if(!T)return;S.classList.add("gaming__heart-active"),e(L=>[...L,T]);let P=!1;for(let L=0;L<t.length;L++)t[L].id==N&&(P=!0);if(P){const L=t.filter(R=>R.id!=N);e(L)}}},Mt())});w.useEffect(()=>{const h=document.querySelectorAll(".gaming__heart-btn");for(let g=0;g<h.length;g++){const v=h[g],y=v.dataset.gameid;for(let C=0;C<t.length;C++){const p=t[C].id;y==p&&v.classList.add("gaming__heart-active")}}});const d=c();return _("section",{className:"gaming__wishlist-section",children:A("main",{className:"gaming__main-container",children:[_("div",{className:"gaming__main-content",children:d}),s&&_(hh,{gamesForCart:n,setGamesForCart:r,setCartPanelIsOpened:u,cartPanelIsOpened:a}),s&&_(dh,{gamesForCart:n,cartPanelIsOpened:a,setCartPanelIsOpened:u})]})})},rR=({wishList:t,setWishList:e,gamesForCart:n,setGamesForCart:r,setBuyBtnActive:i,userIsLogedIn:s,setWishlistBtnActive:o,games:l,cartPanelIsOpened:a,setCartPanelIsOpened:u})=>_(nR,{wishList:t,setWishList:e,gamesForCart:n,setGamesForCart:r,setBuyBtnActive:i,userIsLogedIn:s,setWishlistBtnActive:o,games:l,cartPanelIsOpened:a,setCartPanelIsOpened:u}),iR=({setBuyBtnActive:t,setGamesForCart:e,setWishlistBtnActive:n,setWishList:r})=>_("button",{onClick:()=>{t(!1),n(!1),PI(Xn).then(()=>{e([])}).then(()=>{r([])}).catch(s=>{})},className:"gaming__log-out-btn",children:"Log Out"});function sR({mainMenuIsClosed:t,setMainMenuIsClosed:e,userIsLogedIn:n,setBuyBtnActive:r,setGamesForCart:i,setWishlistBtnActive:s,wishList:o,setWishList:l}){const a=w.useRef(null),u=a.current,d=ci().pathname,h=(p,f=u)=>{p==="||"&&(d==="/register"||d==="/login")&&(f.classList.remove("gaming__navbar--big-position-static"),f.classList.add("gaming__navbar--sm-position-fixed"),f.classList.add("gaming__navbar--big-position-fixed")),p==="&&"&&d!=="/register"&&d!=="/login"&&(f.classList.add("gaming__navbar--big-position-static"),f.classList.add("gaming__navbar--sm-position-fixed"),f.classList.remove("gaming__navbar--big-position-fixed"))};window.onload=()=>{const p=document.querySelector("nav");h("||",p),h("&&",p)},u!==null&&h("||"),u!==null&&h("&&");function g(){u.classList.remove("gaming__navbar-opened"),e(!0)}const y=uC().map(p=>A(sC,{className:({isActive:f})=>f?"gaming__navbar-link-active":null,to:`${p.destination}`,children:[_("ion-icon",{name:`${p.iconName}`}),A("li",{children:[p.text," ",p.text==="Wish List"?`(${o.length})`:null]})]},Mt()));return A("nav",{ref:a,className:"gaming__navbar ",children:[!n&&A("div",{className:"gaming__navbar-account",children:[_(lC,{}),_(aC,{})]}),n&&_("div",{className:"gaming__navbar-account",children:_(iR,{setGamesForCart:i,setBuyBtnActive:r,setWishlistBtnActive:s,setWishList:l})}),t?null:_("button",{onClick:g,className:"gaming__navbar-close-btn btn",children:_("img",{className:"gaming__navbar-close-icon",src:"../Assets/arrowBack.png"})}),_("ul",{children:y}),_("hr",{})]})}function oR(){return A("svg",{className:"gaming__open-nav-icon",xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 512 512",children:[_("title",{children:"Grid"}),_("rect",{x:"48",y:"48",width:"176",height:"176",rx:"20",ry:"20",fill:"none",stroke:"currentColor",strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:"32"}),_("rect",{x:"288",y:"48",width:"176",height:"176",rx:"20",ry:"20",fill:"none",stroke:"currentColor",strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:"32"}),_("rect",{x:"48",y:"288",width:"176",height:"176",rx:"20",ry:"20",fill:"none",stroke:"currentColor",strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:"32"}),_("rect",{x:"288",y:"288",width:"176",height:"176",rx:"20",ry:"20",fill:"none",stroke:"currentColor",strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:"32"})]})}function lR({mainMenuIsClosed:t,setMainMenuIsClosed:e,filterPanelIsOpened:n}){const r=w.useRef(null);function i(){if(!r.current)return;const l=document.querySelectorAll("rect"),a=document.querySelector(".gaming__navbar");r.current.classList.add("menu-shrink");let u=[0,.2,.3,.4];l.forEach((c,d)=>{n?c.style.animation=`shrink-rect-left 0.25s ${u[d]}s ease-in-out forwards`:c.style.animation=`shrink-rect-left 0.25s ${u[d]}s ease-in-out forwards`}),r.current.addEventListener("animationend",function(c){c.target===this&&(e(!1),a.classList.add("gaming__navbar-opened"))})}function s(){i()}return(()=>{r.current&&(n?(r.current.classList.remove("gaming__display-menu-btn"),r.current.classList.add("gaming__hide-menu-btn")):(r.current.classList.remove("gaming__hide-menu-btn"),r.current.classList.add("gaming__display-menu-btn")))})(),t?_("button",{ref:r,onClick:s,className:"gaming__open-nav-btn btn",children:_(oR,{})}):null}const aR=({mainMenuIsClosed:t,setMainMenuIsClosed:e,filterPanelIsOpened:n,userIsLogedIn:r,setBuyBtnActive:i,setGamesForCart:s,setWishlistBtnActive:o,wishList:l,setWishList:a})=>A(w.Fragment,{children:[_("div",{className:"gaming__menus-container",children:_(lR,{filterPanelIsOpened:n,mainMenuIsClosed:t,setMainMenuIsClosed:e})}),_(sR,{setBuyBtnActive:i,setWishlistBtnActive:o,userIsLogedIn:r,mainMenuIsClosed:t,setMainMenuIsClosed:e,setGamesForCart:s,wishList:l,setWishList:a}),_(YE,{})]});function uR(){return _("section",{className:"gaming__hero-section",children:A("div",{className:"gaming__hero-container",children:[_("img",{className:"gaming__hero-img-big",src:"../Assets/heroImg.webp"}),A("header",{children:[A("div",{className:"gaming__hero-heading-container",children:[_("img",{className:"gaming__logo",src:"../../../Assets/logo.svg"}),_("h1",{className:"gaming__hero-heading",children:"Retro Gaming"})]}),_("p",{className:"gaming__hero-text",children:"Welcome to Retro Gaming World, we specialize in selling classic and retro games for a variety of platforms, including the Nintendo Entertainment System, Super Nintendo Entertainment System, Sega Genesis, and more."}),_("p",{className:"gaming__hero-text",children:"At Retro Gaming World, we believe that every gamer should have the opportunity to experience the nostalgia and excitement of retro gaming. That's why we offer a wide selection of games at affordable prices, so you can relive your childhood memories or discover new favorites without breaking the bank. Our inventory is constantly updating, so be sure to check back often for new arrivals."}),_("button",{className:"gaming__hero-btn",children:"See Our Games"})]}),_("img",{className:"gaming__hero-img-sm",src:"../Assets/heroImg.webp"})]})})}const cR=()=>_("div",{});const dR=()=>_("div",{}),hR=({mainMenuIsClosed:t,setMainMenuIsClosed:e})=>A(w.Fragment,{children:[_(uR,{mainMenuIsClosed:t,setMainMenuIsClosed:e}),_(cR,{}),_(dR,{})]});const fR=({setFilteredGamesBySearchBar:t,games:e})=>{const n=i=>{let s=[];const o=i.target.value.toLowerCase(),l=o.length;if(o===""&&(s=[],t(s)),!(e.length===0||!o)){for(let a=0;a<e.length;a++){const u=e[a],c=u.name.toLowerCase();o===c.slice(0,l)&&s.push(u)}t(s)}},r=w.useRef(null);return A("div",{ref:r,className:"gaming__searchbar",children:[_("input",{onChange:i=>{n(i)},placeholder:"Search Game",onFocus:()=>{r.current.classList.add("add-shadow")},onBlur:()=>{r.current.classList.remove("add-shadow")},className:"gaming__searchbar-input",type:"text"}),_("ion-icon",{name:"search"})]})};const pR=({setFilterPanelIsOpened:t,setOpenFilterBtnRef:e})=>{const n=w.useRef(null);return _("button",{ref:n,onClick:()=>{n.current.classList.remove("gaming__display-open-btn"),n.current.classList.add("gaming__hide-open-btn"),t(!0),n.current&&e(n)},className:"gaming__open-filter",children:_("ion-icon",{name:"search"})})};const Ja=({updateFilter:t,genresLists:e,ratingLists:n,priceLists:r,getRefForFilters:i,criterion:s,filtersToBeDisplayedRefs:o,ulListsAreOpened:l,setUlListsAreOpened:a,tabWasClickedTwice:u,setTabWasClickedTwice:c,numOfOpenLists:d,setNumOfOpenLists:h,currentTab:g,setCurrentTab:v})=>{const y=w.useRef(null);i(y);const C=f=>{f.stopPropagation();const m=f.target.nextElementSibling===null?f.target.parentElement.nextElementSibling:f.target.nextElementSibling;let E=m.dataset.ulType;v(E),a(S=>({...S,[E]:!S[E]}));for(let S=0;S<o.length;S++)if(o.length>0){if(m===o[S].current)continue;o[S].current.classList.remove("gaming__filter-ul-visible-delayed"),o[S].current.classList.add("gaming__filter-ul-hidden")}d===2?y.current&&(y.current.classList.toggle("gaming__filter-ul-hidden"),y.current.classList.add("gaming__filter-ul-visible-delayed")):y.current&&y.current.classList.toggle("gaming__filter-ul-hidden"),u[E]&&y.current.classList.remove("gaming__filter-ul-visible-delayed");for(const S in l)S!==E&&a(N=>({...N,[S]:!1}))};w.useEffect(()=>{h(1);for(const f in l)l[f]&&h(m=>m+1)},[l]),w.useEffect(()=>{if(g){for(const f in u)g!==f&&c(m=>({...m,[f]:!1}));c(f=>({...f,[g]:!0}))}},[g]);let p;switch(s){case"Genres":p=e;break;case"Rating":p=n;break;case"Price":p=r}return A("div",{className:"gaming__filter-inner-container",children:[_("div",{onClick:C,className:"gaming__filter-name",children:A("p",{children:[" ",s]})}),_("ul",{"data-ul-type":s,onClick:f=>{t(f)},ref:y,className:"gaming__filter-ul-visible gaming__filter-ul-hidden",children:p})]})};const mR=({setFilterPanelIsOpened:t,openFilterBtnRef:e})=>_("button",{onClick:()=>{e.current.classList.remove("gaming__hide-open-btn"),e.current.classList.add("gaming__display-open-btn"),t(!1)},className:"gaming__close-filter",children:_("ion-icon",{name:"close"})}),gR=({filterPanelIsOpened:t,setFilterPanelIsOpened:e,games:n,openFilterBtnRef:r,setOpenFilterBtnRef:i,pageContents:s,setPageContents:o,numberOfPages:l,displayOverlayGamesNotFound:a,setDisplayOverlayGamesNotFound:u,areInitialNumberOfPages:c,setAreInitialNumberOfPages:d,setCartPanelIsOpened:h,cartPanelIsOpened:g,setBuyBtnActive:v,gamesForCart:y,setGamesForCart:C,userIsLogedIn:p,wishList:f,setWishList:m,setWishlistBtnActive:E})=>{const[S,N]=w.useState([]),[T,P]=w.useState({}),[L,R]=w.useState(0),[q,Ut]=w.useState([]),[fe,_e]=w.useState([]),[me,Ue]=w.useState([]),[ot,x]=w.useState([]),[b,U]=w.useState(null),[Z,le]=w.useState(null),[Bt,lt]=w.useState({Genres:!1,Rating:!1,Price:!1}),[an,at]=w.useState({Genres:!1,Rating:!1,Price:!1}),[zt,Ks]=w.useState(1),qs=w.useRef(null),my=["1 star","2 stars","3 stars","4 stars","5 stars"],gy=["10$","15$","20$","22$"];w.useEffect(()=>{(async()=>{const V=await(await fetch("http://localhost:5002")).json();N(V)})()},[]);const _y=B=>{if(!B.target.closest(".gaming__filter-ul-visible")){Ks(1),le(null),lt({Genres:!1,Rating:!1,Price:!1}),at({Genres:!1,Rating:!1,Price:!1});for(let D=0;D<ot.length;D++)ot[D].current.classList.add("gaming__filter-ul-hidden"),ot[D].current.classList.remove("gaming__filter-ul-visible-delayed")}},sa=(B,D)=>B.map((V,Y)=>A("li",{children:[V,_("input",{"data-i":Y,"data-filter-item":V,"data-filter-type":D,type:"checkbox"})]},Mt())),vy=sa(S,"genre"),yy=sa(my,"rating"),wy=sa(gy,"price"),oa=B=>{R(0);const D=B.target,V=D.checked;if(D.nodeName!="INPUT")return;const Y=[D.dataset.filterItem],G=D.dataset.filterType,ee=[+D.dataset.i],Oe=(mt,Rt)=>{mt(Be=>{let Wt;return V?Wt=Array.isArray(Be[G])?Be[G]:[]:Wt=[],{...Be,[G]:[...Wt,...Rt]}})};if(!V){const mt=me[G].filter(Be=>Be!==ee[0]),Rt=T[G].filter(Be=>Be!==Y[0]);Oe(P,Rt),Oe(Ue,mt)}T[G]&&T[G].includes(Y[0])||(Oe(P,Y),Oe(Ue,ee))};w.useEffect(()=>{(()=>{if(n.length===0)return;let D=[],V;for(let Y=0;Y<n.length;Y++){V=null;const G=n[Y],ee=G.genres,Oe=G.starRating,mt=G.price,Rt={genre:[],rating:[],price:[]};if(ee){if(T.hasOwnProperty("genre"))for(let Be=0;Be<ee.length;Be++){const Wt=ee[Be].name;Rt.genre.push(Wt)}T.hasOwnProperty("rating")&&Rt.rating.push(Oe),T.hasOwnProperty("price")&&Rt.price.push(mt);for(const Be in T){if(V===!1)break;for(let Wt=0;Wt<T[Be].length;Wt++)if(Rt[Be].includes(T[Be][Wt]))V=!0;else{V=!1;break}}V&&D.push(G)}}Ut(D)})()},[n,me]),w.useEffect(()=>{const B=document.querySelectorAll("input[data-filter-item]");let D={};for(const V in me){D[V]||(D[V]=[]);for(let Y=0;Y<B.length;Y++)for(let G=0;G<me[V].length;G++)+B[Y].dataset.i===me[V][G]&&B[Y].dataset.filterType===V&&(D[V].includes(B[Y])||D[V].push(B[Y]));D[V].forEach(Y=>{Y.setAttribute("checked","")})}},[me,L,q,s,t,a,c,b,zt,Bt,an,Z,fe]),(()=>{qs.current&&(t?qs.current.classList.add("gaming__filter-opened"):qs.current.classList.remove("gaming__filter-opened"))})(),w.useEffect(()=>()=>{e(!1)},[]);const la=(B=n)=>{let D=[];const Y=Math.ceil(B.length/40);B===n&&d(!0),Y||u(!0);let G=0;for(let ee=0;ee<Y;ee++){D.push([]),ee===0?G=0:G=G+40-1,ee>0&&(G+=1);for(let Oe=G;Oe<B.length;Oe++){const mt=D[ee],Rt=B[Oe];mt.length!=40&&mt.push(Rt)}}o(D)};w.useEffect(()=>{const B=n.length>0;let D;for(const V in T)if(T[V].length>0){D=!0;break}B&&!D&&fe.length===0?la():la(D?q:fe)},[q,fe]);const Ey=()=>{L!==0&&R(B=>B-1)},Cy=()=>{L>l-2||R(B=>B+1)},Sy=B=>{let D=B.target.value;D>=0&&D<=l-1&&R(+D)},Iy=B=>{if(E(!0),!p)return;B.stopPropagation();const D=B.target.parentElement,V=+D.dataset.gameid,Y=n.find(ee=>ee.id===V);if(!Y)return;D.classList.add("gaming__heart-active"),m(ee=>[...ee,Y]);let G=!1;for(let ee=0;ee<f.length;ee++)f[ee].id==V&&(G=!0);if(G){const ee=f.filter(Oe=>Oe.id!=V);m(ee)}},fh=(()=>s.length>0&&L>=0&&s[L].map(D=>{const V=D.cover.url.replace("t_thumb","t_cover_big"),Y=D.name.toUpperCase(),G=D.price,ee=+D.starRating.slice(0,1),Oe=[];for(let mt=0;mt<ee;mt++)Oe.push(_("ion-icon",{name:"star"},Mt()));return _(cy,{gameCover:V,gameName:Y,gamePrice:G,starIcons:Oe,game:D,userIsLogedIn:p,gamesForCart:y,setGamesForCart:C,setBuyBtnActive:v,updateWishList:Iy},Mt())}))();w.useEffect(()=>{const B=document.querySelectorAll(".gaming__heart-btn");for(let D=0;D<B.length;D++){const V=B[D],Y=V.dataset.gameid;for(let G=0;G<f.length;G++){if(!f[G])continue;const ee=f[G].id;Y==ee&&V.classList.add("gaming__heart-active")}}},[f,fh]),w.useEffect(()=>{U(document.querySelector(".gaming__menus-container"))},[]);const ky=b&&tE.createPortal(_(pR,{setFilterPanelIsOpened:e,setOpenFilterBtnRef:i}),b),aa=B=>{w.useEffect(()=>{x(D=>[...D,B])},[])};return A("section",{onClick:B=>{_y(B)},className:"gaming__shop-section",children:[A("div",{ref:qs,className:"gaming__filter-container",children:[A("div",{className:"gaming__searchbar-container",children:[_(fR,{games:n,setFilteredGamesBySearchBar:_e}),_(mR,{openFilterBtnRef:r,setFilterPanelIsOpened:e})]}),_("p",{children:"Filter By:"}),A("div",{className:"gaming__filters",children:[_(Ja,{criterion:"Genres",updateFilter:oa,genresLists:vy,getRefForFilters:aa,filtersToBeDisplayedRefs:ot,ulListsAreOpened:Bt,setUlListsAreOpened:lt,tabWasClickedTwice:an,setTabWasClickedTwice:at,numOfOpenLists:zt,setNumOfOpenLists:Ks,currentTab:Z,setCurrentTab:le}),_(Ja,{criterion:"Rating",updateFilter:oa,ratingLists:yy,getRefForFilters:aa,filtersToBeDisplayedRefs:ot,ulListsAreOpened:Bt,setUlListsAreOpened:lt,tabWasClickedTwice:an,setTabWasClickedTwice:at,numOfOpenLists:zt,setNumOfOpenLists:Ks,currentTab:Z,setCurrentTab:le}),_(Ja,{criterion:"Price",updateFilter:oa,priceLists:wy,getRefForFilters:aa,filtersToBeDisplayedRefs:ot,ulListsAreOpened:Bt,setUlListsAreOpened:lt,tabWasClickedTwice:an,setTabWasClickedTwice:at,numOfOpenLists:zt,setNumOfOpenLists:Ks,currentTab:Z,setCurrentTab:le})]}),A("div",{className:"gaming__mobile-pages",children:[_("p",{className:"gaming__mobile-pages-text",children:"Go to page:"}),_("button",{onClick:Ey,className:"gaming__mobile-pages-prev",children:_("ion-icon",{name:"remove"})}),_("input",{value:L.toString(),onChange:B=>{Sy(B)},className:"gaming__mobile-pages-input",type:"number"}),_("button",{onClick:Cy,className:"gaming__mobile-pages-next",children:_("ion-icon",{name:"add"})}),_("span",{className:"gaming__mobile-pages-span",children:"/"}),_("span",{className:"gaming__mobile-pages-span",children:l-1})]})]}),p&&_(hh,{gamesForCart:y,setGamesForCart:C,setCartPanelIsOpened:h,cartPanelIsOpened:g}),p&&_(dh,{gamesForCart:y,cartPanelIsOpened:g,setCartPanelIsOpened:h}),_("main",{className:"gaming__main-container",children:_("div",{className:"gaming__main-content",children:fh})}),ky]})},_R=({filterPanelIsOpened:t,setFilterPanelIsOpened:e,games:n,openFilterBtnRef:r,setOpenFilterBtnRef:i,pageContents:s,setPageContents:o,numberOfPages:l,displayOverlayGamesNotFound:a,setDisplayOverlayGamesNotFound:u,areInitialNumberOfPages:c,setAreInitialNumberOfPages:d,setGameId:h,setCartPanelIsOpened:g,cartPanelIsOpened:v,setBuyBtnActive:y,gamesForCart:C,setGamesForCart:p,userIsLogedIn:f,wishList:m,setWishList:E,setWishlistBtnActive:S})=>_(gR,{pageContents:s,setPageContents:o,numberOfPages:l,openFilterBtnRef:r,setOpenFilterBtnRef:i,games:n,filterPanelIsOpened:t,setFilterPanelIsOpened:e,displayOverlayGamesNotFound:a,setDisplayOverlayGamesNotFound:u,areInitialNumberOfPages:c,setAreInitialNumberOfPages:d,setGameId:h,setCartPanelIsOpened:g,cartPanelIsOpened:v,setBuyBtnActive:y,gamesForCart:C,setGamesForCart:p,userIsLogedIn:f,wishList:m,setWishList:E,setWishlistBtnActive:S});const vR=()=>(w.useEffect(()=>{let t;async function e(){const n={lat:45.7589515,lng:21.2194093},{Map:r}=await google.maps.importLibrary("maps"),{AdvancedMarkerView:i}=await google.maps.importLibrary("marker");t=new r(document.getElementById("map"),{zoom:13,center:n,mapId:"contact_map"}),new i({map:t,position:n,title:"Timisoara"})}e()},[]),_("div",{className:"test",id:"map"}));const yR=()=>_("section",{className:"gaming__contact-section",children:A("main",{className:"gaming__contact-main-content",children:[_("div",{className:"gaming__contact-details-container",children:A("ul",{className:"gaming__contact-details-ul",children:[A("li",{children:[_("span",{children:"Phone Number:"})," 07xx-xxx-xxx"]}),A("li",{children:[_("span",{children:"Email:"})," someRandomMail@gmail.com"]}),A("li",{children:[_("span",{children:"Location:"})," Some location"]})]})}),_(vR,{})]})}),wR=()=>_(w.Fragment,{children:_(yR,{})}),dy=(t,e=300)=>{let n;return(...r)=>{clearTimeout(n),n=setTimeout(()=>{t.apply(globalThis,r)},e)}},hy=({setUserEmail:t})=>{const e=dy(n=>{t(n.target.value)});return _("input",{onChange:e,placeholder:"email",className:"gaming__account-form-input",type:"email"})},fy=({validatePassword:t,userPassword:e,setUserPassword:n})=>{const r=dy(i=>{n(i.target.value)});return w.useEffect(()=>{t&&t(e)},[e]),_("input",{onChange:i=>{r(i)},placeholder:"pass",className:"gaming__account-form-input",type:"password"})};const ER=()=>{const[t,e]=w.useState(""),[n,r]=w.useState("");return _("div",{className:"gaming__account-container",children:A("form",{onSubmit:async s=>{s.preventDefault();try{const l=(await kI(Xn,t,n)).user}catch(o){console.log(o)}},className:"gaming__account-form",children:[_(hy,{setUserEmail:e}),_(fy,{setUserPassword:r}),_("button",{type:"submit",className:"gaming__account-login-btn",children:"Log In"})]})})};const py=({redirectSecondsFromLogin:t,redirectSecondsFromRegister:e})=>A("div",{className:"gaming__redirect-to-shop-overlay",children:[t&&A("p",{className:"gaming__redirect-to-shop-overlay-text",children:["You will be redirected to the shoping page in"," ",t," ",t===1?"second":"seconds"]}),e&&A("p",{className:"gaming__redirect-to-shop-overlay-text",children:["You will be redirected to the shoping page in"," ",e," ",e===1?"second":"seconds"]})]}),CR=({userIsLogedIn:t})=>{const[e,n]=w.useState(3),r=fd();return w.useEffect(()=>{e===0&&r("/shop"),!(!t||e===0)&&setTimeout(()=>{n(i=>i-1)},1e3)},[t,e]),A(w.Fragment,{children:[!t&&_("section",{className:"gaming__login-section",children:_(ER,{})}),t&&e&&_(py,{redirectSecondsFromLogin:e})]})},SR=()=>{const t={hasNumber:!1,hasUpperCase:!1,hasSpecialChar:!1,minPassLength:7},[e,n]=w.useState(""),[r,i]=w.useState(""),[s,o]=w.useState(t),l=(c,d)=>{o(h=>({...h,[c]:d}))},a=c=>{const d=["!","@","#","$","%","&","'","(",")","*","+",",","-",".","/",":",";","<","=",">","?","@","[","\\","]","^","_","`","{","|","}","~"];for(let v=0;v<c.length;v++){const y=c[v],C=Number(y),p=d.some(function(f){return y===f});C&&l("hasNumber",!0),y===y.toUpperCase()&&!C&&!p&&l("hasUpperCase",!0),p&&l("hasSpecialChar",!0)}const h=()=>{d.some(function(y){return c.includes(y)})||l("hasSpecialChar",!1)},g=(v,y,C)=>{v.test(c)||l(y,C)};return g(/\d/,"hasNumber",!1),g(/[A-Z]/,"hasUpperCase",!1),h(),!!(s.hasNumber&&s.hasUpperCase&&s.hasSpecialChar)};return _("div",{className:"gaming__account-container",children:A("form",{onSubmit:async c=>{if(!(r.length<t.minPassLength)&&a(r)){c.preventDefault();try{const d=await II(Xn,e,r)}catch(d){console.log(d.message)}}},className:"gaming__account-form",children:[_(hy,{setUserEmail:n}),_(fy,{validatePassword:a,userPassword:r,setUserPassword:i}),_("button",{className:"gaming__account-register-btn",children:"Create Account"}),_("div",{className:"gaming__account-validation",children:A("ul",{children:[A("li",{className:`gaming__account-validation-li-${s.hasUpperCase?"correct":"wrong"}`,children:[_("span",{children:"→"}),"atleast one upper case character;"]}),A("li",{className:`gaming__account-validation-li-${s.hasNumber?"correct":"wrong"}`,children:[_("span",{children:"→"})," atleast one number character;"]}),A("li",{className:`gaming__account-validation-li-${s.hasSpecialChar?"correct":"wrong"}`,children:[_("span",{children:"→"})," atleast one special character;"]}),A("li",{className:`gaming__account-validation-li-${r.length>=s.minPassLength?"correct":"wrong"}`,children:[_("span",{children:"→"}),"password length must be atleast 7;"]})]})})]})})};const IR=({userIsLogedIn:t})=>{const e=fd(),[n,r]=w.useState(3);return w.useEffect(()=>{n===0&&e("/shop"),!(!t||n===0)&&setTimeout(()=>{r(i=>i-1)},1e3)},[t,n]),A(w.Fragment,{children:[!t&&_("section",{className:"gaming__register-section",children:_(SR,{})}),t&&n&&_(py,{redirectSecondsFromRegister:n})]})};const kR=({numberOfPages:t,displayOverlayGamesNotFound:e,setDisplayOverlayGamesNotFound:n})=>{const r=w.useRef(null),i=window.location.pathname;return _(w.Fragment,{children:!t&&i==="/shop"&&e&&_("div",{ref:r,className:"gaming__games-not-found-overlay",children:A("div",{className:"gaming__games-not-found-overlay-container",children:[_("p",{className:"gaming__games-not-found-message",children:"We didn't find any games to match your query"}),_("button",{className:"gaming__games-not-found-close-overlay-btn",onClick:()=>n(!1),children:"OK"})]})})})};const TR=()=>_("a",{href:"/login",className:"gaming__redirect-to-login-btn",children:"Log In"});const NR=()=>_("a",{href:"/register",className:"gaming__redirect-to-register-btn",children:"Create account"});const RR=({setBuyBtnActive:t,setWishlistBtnActive:e})=>_("button",{onClick:()=>{e(!1),t(!1)},className:"gaming__close-redirect-overlay-btn",children:_("ion-icon",{name:"close"})});const PR=({buyBtnActive:t,setBuyBtnActive:e,wishlistBtnActive:n,setWishlistBtnActive:r})=>_("div",{onClick:()=>{r(!1),e(!1)},className:"gaming__redirect-to-account-backdrop-shadow",children:A("div",{className:"gaming__redirect-to-account-overlay-container",children:[_(RR,{setWishlistBtnActive:r,setBuyBtnActive:e}),A("p",{className:"gaming__redirect-to-account-text",children:["To ",t&&"purchase",n&&"list that game"," please log in or create an account."]}),A("div",{className:"gaming__redirect-to-account-overlay-btns-container",children:[_(TR,{}),_(NR,{})]})]})}),xR=({areInitialNumberOfPages:t,numberOfPages:e,displayOverlayGamesNotFound:n,setDisplayOverlayGamesNotFound:r,userIsLogedIn:i,buyBtnActive:s,setBuyBtnActive:o,wishlistBtnActive:l,setWishlistBtnActive:a})=>A(w.Fragment,{children:[t&&_(kR,{numberOfPages:e,displayOverlayGamesNotFound:n,setDisplayOverlayGamesNotFound:r}),!i&&(s||l)&&_(PR,{wishlistBtnActive:l,setWishlistBtnActive:a,buyBtnActive:s,setBuyBtnActive:o})]});const OR=({userIsLogedIn:t,setSelectedTab:e,gamesForCart:n,setGamesForCart:r,game:i,setBuyBtnActive:s})=>{const o=w.useRef(null),l=w.useRef(null);return _(w.Fragment,{children:A("div",{className:"gaming__current-game-selections-container",children:[_("button",{ref:o,onClick:a=>{a.target.classList.add("selected-btn"),l.current.classList.remove("selected-btn"),e("about")},className:"gaming__current-game-selection-btn selected-btn",children:"About game"}),_("button",{ref:l,onClick:a=>{a.target.classList.add("selected-btn"),o.current.classList.remove("selected-btn"),e("screenshots")},className:"gaming__current-game-selection-btn",children:"Screenshots"}),_(uy,{userIsLogedIn:t,setBuyBtnActive:s,game:i,gamesForCart:n,setGamesForCart:r})]})})},AR=({userIsLogedIn:t,games:e,cartPanelIsOpened:n,setCartPanelIsOpened:r,gamesForCart:i,setGamesForCart:s,setBuyBtnActive:o})=>{const l=()=>{const[a,u]=w.useState("about");let c;const h=window.location.pathname.split("/"),g=+h[h.length-1];for(let R=0;R<e.length;R++){const q=e[R];q.id===g&&(c=q)}if(!c)return;const v=c.cover.url.replace("t_thumb","t_720p"),y=+c.starRating.slice(0,1),C=new Date(c.first_release_date*1e3),p=C.toLocaleString("default",{month:"short"}),f=C.getFullYear(),m=C.getDate();let E=[];if(c.screenshots)for(let R=0;R<c.screenshots.length;R++){const q=c.screenshots[R].url;E.push(q)}const S=E.map(R=>_("li",{children:_("img",{src:R})},Mt()));let N=[];for(let R=0;R<y;R++)N.push(_("ion-icon",{name:"star"},Mt()));let T=[];for(let R=0;R<c.genres.length;R++){const q=" "+c.genres[R].name;T.push(q)}let P=[];for(let R=0;R<c.platforms.length;R++){const q=c.platforms[R].abbreviation;q&&P.push(q)}const L=P.map(R=>_("li",{children:R},Mt()));return A(w.Fragment,{children:[A("div",{className:"gaming__current-game-details-container",children:[_("img",{className:"gaming__current-game-img",src:v}),_("div",{className:"gaming__current-game-overlay"}),_(OR,{userIsLogedIn:t,game:c,setBuyBtnActive:o,gamesForCart:i,setGamesForCart:s,setSelectedTab:u})]}),a==="about"&&_("div",{className:"gaming__current-game-about-container",children:A("ul",{className:"gaming__current-game-selection-details-ul",children:[A("li",{className:"gaming__current-game-detail",children:[_("span",{children:"Game name:"})," "+c.name]}),A("li",{className:"gaming__current-game-detail",children:[_("span",{children:"Genres:"})," "+T.join(",")]}),A("li",{className:"gaming__current-game-detail",children:[_("span",{children:"Rating:"})," ",N]}),A("li",{className:"gaming__current-game-detail",children:[_("span",{children:"Release date:"})," "+p,"/",m,"/",f]}),A("li",{className:"gaming__current-game-detail-platforms",children:[_("p",{children:"Supported platforms:"}),_("ul",{className:"gaming__current-game-platforms",children:L})]})]})}),a==="about"&&A("p",{className:"gaming__current-game-detail-summary",children:[_("span",{children:"Game description :"})," ",c.summary]}),a==="screenshots"&&_("div",{className:"gaming__current-game-screenshots-container",children:S})]})};return w.useEffect(()=>{r(!1)},[]),A("section",{className:"gaming__current-game-details-section",children:[_("main",{children:l()}),_(hh,{setGamesForCart:s,gamesForCart:i,cartPanelIsOpened:n,setCartPanelIsOpened:r}),_(dh,{gamesForCart:i,cartPanelIsOpened:n,setCartPanelIsOpened:r})]})};function LR(){const[t,e]=w.useState(!0),[n,r]=w.useState(!1),[i,s]=w.useState(!1),[o,l]=w.useState([]),[a,u]=w.useState([]),c=a.length>0&&a.length,[d,h]=w.useState(null),[g,v]=w.useState(!0),[y,C]=w.useState(null),[p,f]=w.useState(!1),[m,E]=w.useState(!1),[S,N]=w.useState(!1),[T,P]=w.useState([]),[L,R]=w.useState([]);w.useEffect(()=>{RI(Xn,fe=>{f(!!fe)})});const q=[...o];w.useEffect(()=>{(async()=>{const me=await(await fetch("http://localhost:5000")).json();l(me)})()},[]),w.useEffect(()=>{if(!p)return;const fe=Xn.currentUser&&Xn.currentUser.uid,_e=oy(ay,"users/"+fe);jN(_e,me=>{const Ue=me.val(),ot=Ue&&Ue.gamesForWishList,x=JSON.parse(ot);Ue&&Ue.gamesForWishList&&R(x);const b=Ue&&Ue.gamesForCart,U=JSON.parse(b);Ue&&Ue.gamesForCart&&P(U)})},[p]),w.useEffect(()=>{if(!p)return;const fe=Xn.currentUser.uid;tR(fe,{gamesForCart:JSON.stringify(T),gamesForWishList:JSON.stringify(L)})},[T,L]);const Ut=()=>{for(let fe=0;fe<q.length;fe++){const _e=q[fe],me=_e.rating;me<=20?(_e.starRating="1 star",_e.price="10$"):me>20&&me<=40?(_e.starRating="2 stars",_e.price="10$"):me>40&&me<=60?(_e.starRating="3 stars",_e.price="15$"):me>60&&me<=80?(_e.starRating="4 stars",_e.price="20$"):(_e.starRating="5 stars",_e.price="22$")}};return q.length>0&&Ut(),w.useEffect(()=>{l(q)},[]),A(w.Fragment,{children:[_(xR,{buyBtnActive:m,setBuyBtnActive:E,userIsLogedIn:p,areInitialNumberOfPages:y,numberOfPages:c,displayOverlayGamesNotFound:g,setDisplayOverlayGamesNotFound:v,wishlistBtnActive:S,setWishlistBtnActive:N}),_(rC,{children:_(XE,{children:A(xt,{path:"/",element:_(aR,{setBuyBtnActive:E,setWishlistBtnActive:N,userIsLogedIn:p,setOpenFilterBtnRef:h,setFilterPanelIsOpened:r,filterPanelIsOpened:n,mainMenuIsClosed:t,setMainMenuIsClosed:e,setGamesForCart:P,wishList:L,setWishList:R}),children:[_(xt,{index:!0,element:_(hR,{mainMenuIsClosed:t,setMainMenuIsClosed:e})}),_(xt,{path:"/shop",element:_(_R,{pageContents:a,setPageContents:u,numberOfPages:c,openFilterBtnRef:d,setOpenFilterBtnRef:h,games:o,filterPanelIsOpened:n,setFilterPanelIsOpened:r,displayOverlayGamesNotFound:g,setDisplayOverlayGamesNotFound:v,areInitialNumberOfPages:y,setAreInitialNumberOfPages:C,setCartPanelIsOpened:s,cartPanelIsOpened:i,setBuyBtnActive:E,gamesForCart:T,setGamesForCart:P,userIsLogedIn:p,wishList:L,setWishList:R,setWishlistBtnActive:N})}),_(xt,{path:"/shop/:gameId",element:_(AR,{userIsLogedIn:p,cartPanelIsOpened:i,setCartPanelIsOpened:s,games:o,gamesForCart:T,setGamesForCart:P,setBuyBtnActive:E})}),_(xt,{path:"wishlist",element:_(rR,{gamesForCart:T,setGamesForCart:P,wishList:L,setWishList:R,setBuyBtnActive:E,userIsLogedIn:p,setWishlistBtnActive:N,games:o,cartPanelIsOpened:i,setCartPanelIsOpened:s})}),_(xt,{path:"contact",element:_(wR,{})}),_(xt,{path:"login",element:_(CR,{userIsLogedIn:p})}),_(xt,{path:"register",element:_(IR,{userIsLogedIn:p})}),_(xt,{path:"*",element:_(Error,{})})]})})})]})}Za.createRoot(document.getElementById("root")).render(_(LR,{}));
